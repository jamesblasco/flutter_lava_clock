...
///
/// To use the [CustomClockCustomizer], pass your clock into it, using a ClockBuilder.
///
/// ```
///   final myClockBuilder = (ClockModel model) => AnalogClock(model);
...
/// ```
/// Contestants: Do not edit this.
class CustomClockCustomizer extends StatefulWidget {
  const CustomClockCustomizer(this._clock);

  /// The clock widget with [ClockModel], to update and display.
  final ClockBuilder _clock;

  @override
  _CustomClockCustomizerState createState() => _CustomClockCustomizerState();
}

class _CustomClockCustomizerState extends State<CustomClockCustomizer> {
